...
@section('content')
    ...
    <section class="meetings-page" id="meetings">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="meeting-single-item">
                                <div class="thumb">
                                    ...
                                    <a href="Written_Message.html"><img src="assets/images/single-meeting.jpg" alt=""></a>
                                </div>
                                <div class="down-content">
                                    <a href="Written_Message.html"><h4>Online Teaching and Learning Tools</h4></a>
                        ...
                        <div class="col-lg-12">
                            <div class="main-button-red">
                                <a href="Gallery.html">Back To Meetings List</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer">
            <p>Copyright © 2021 RCF ILA-ORANGUN. All Rights Reserved.
